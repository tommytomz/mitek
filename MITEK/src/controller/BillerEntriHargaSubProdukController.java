...
import model.BillerEntriHargaSubProdukModel;
import view.biller.panelEntriHargaSubProduk;

/**
 *
 * @author lenovo
 */
public class BillerEntriHargaSubProdukController {
    BillerEntriHargaSubProdukModel model = new BillerEntriHargaSubProdukModel();
    
    public void subproduk(panelEntriHargaSubProduk inframe){
        
        ValueComboBox valuenamaswitching  = (ValueComboBox) inframe.namaswitching.getSelectedItem();
        model.combobox      = inframe.namasubproduk;
        model.namespace     = "subproduk";
        model.params        = new Params[]{
                                          new Params("ridswitching", valuenamaswitching.getValue()),
    ...
    public void switching(panelEntriHargaSubProduk inframe){
    ...
    public void simpan(panelEntriHargaSubProduk inframe){
