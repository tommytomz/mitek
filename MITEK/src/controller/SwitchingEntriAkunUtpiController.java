...
import model.SwitchingEntriAkunUtpiModel;
import view.switching.panelEntriAkunUtpi;

/**
 *
 * @author lenovo
 */
public class SwitchingEntriAkunUtpiController {
    SwitchingEntriAkunUtpiModel model = new SwitchingEntriAkunUtpiModel();
    
    public void switching(panelEntriAkunUtpi inframe){
    ...
    public void grupsaldo(panelEntriAkunUtpi inframe){
    ...
    public void simpan(panelEntriAkunUtpi inframe){
