...
import model.MitekEntriGrupSaldoModel;
import view.mitek.panelEntriGrupSaldo;

/**
 *
 * @author lenovo
 */
public class MitekEntriGrupSaldoController {
    MitekEntriGrupSaldoModel model = new MitekEntriGrupSaldoModel();
